...
//            begin
//              ShowMessage('O campo '+(Form4.Components[i] as TDBEdit).Hint+' não foi preenchido ');
//              Abort;
//            end;
//      end;
//  end;
  ...
  //        begin
   ...
   //          ShowMessage('O campo '+(Form4.Components[i] as TDBComboBox).Hint+' não foi preenchido ');
   //         Abort;
    //      end;
